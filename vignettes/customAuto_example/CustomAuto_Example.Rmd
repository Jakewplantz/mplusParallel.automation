...
This vignette demonstrates the usage of the custom_auto argument in the mplusParallel_automation function.
...
writeLines(inp_content, "exampleCustom_model_item3.inp")
inp_content <- "
TITLE: TEST
DATA: FILE IS exdat.csv;
VARIABLE:
...
# Write to an inp file
writeLines(inp_content, "exampleCustom_model_item2.inp")
...
res <- mplusParallel_automation(k=5,seed = 4, custom_auto = custom_auto, multi_con = T, data_gen = data_gen) 
